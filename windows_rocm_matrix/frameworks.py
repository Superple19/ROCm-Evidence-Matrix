...
def render_framework_history(document):
    lines = ["<!-- Generated by windows_rocm_matrix.collect. Do not edit manually. -->", "", "# JAX ROCm framework artifacts", "", "These are package artifacts observed in official indexes. They do not prove resolver or runtime compatibility.", "", "| Distribution | Platform | Channel | Lifecycle | ROCm | PJRT | Plugin | Python tags |", "| --- | --- | --- | --- | --- | --- | --- | --- |"]
...
def render_sdk_components(document):
    lines = ["<!-- Generated by windows_rocm_matrix.collect. Do not edit manually. -->", "", "# ROCm SDK component evidence", "", "SDK components are listed separately from framework candidates; their presence does not prove a complete install set.", "", "| Distribution | Platform | Channel | Component | Kind | GFX | Versions |", "| --- | --- | --- | --- | --- | --- | --- |"]
